...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <link rel='stylesheet prefetch' href='https://fonts.googleapis.com/css?family=Open+Sans'>
        ...
        <link rel="stylesheet" type="text/css" href="find.css?ver=1">
</head>
<body>
      ...
      <div class="find-html">
          ...
          <div class="login-form">
              <div class="sign-in-htm">
                <div class="group">
                  ...
                  <div class="group">
                      ...
                      <input id="pass" type="email" class="input" data-type="email" placeholder="이메일 입력">
                  </div>
                  <div class="group">
                ...
                <div class="group">
                  ...
                  <div class="hr"></div>
                  <div class="foot-lnk">
                    <a href="../Null_Login/index.html">회원가입</a>
                    <a href="../Null_Login/index.html" style="margin-left: 10px;">로그인</a>
                </div>
              </div>
              <div class="sign-up-htm">
                ...
                <div class="group">
                    <label for="chknum" class="label" style="margin-top: 30px;">Certification Number</label>
                    <input id="chknum" type="number" class="input" placeholder="인증번호 입력">
                </div>
                  <div class="group">
                      <input type="submit" class="button" value="찾기"/>
                  </div>
